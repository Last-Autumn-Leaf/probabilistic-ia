...
class ClassesTracker :
    def __init__(self,dimension_list=None,dims_list_idx=None):
        ...
        if dimension_list ==None :
            ...
            dimension_list = [dimension(name=d_mean_bin, mode=HSV), dimension(name=d_pred_bin, mode=HSV),
                              dimension(name=d_fractal, mode=RGB)]
        if dims_list_idx == None :
            ...
            self.dims_list_idx = [(d_mean_bin, HSV, 1), (d_pred_bin, HSV, 0), (d_fractal, RGB, 0)]
        else :
